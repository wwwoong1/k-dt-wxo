### 마케팅 에이전트 생성
1. **리소스 목록**에서 AI/기계 학습 하단에 존재하는 Orchestrate를 선택합니다.
   <img width="1000" alt="image" src="img/step1.png">
2. **Orchestrate 실행 버튼을 클릭합니다**
   <img width="1000" alt="image" src="img/step2.png">
3. **화면 좌측 햄버거 버튼**을 클릭해 메뉴를 열고 Build를 클릭합니다.
   <img width="1000" alt="image" src="img/step3.png">
4. **Create agent**를 클릭해 새로운 Agent 생성 화면을 띄웁니다.
   <img width="1000" alt="image" src="img/step4.png">
5. **Create from scratch**를 선택하고 에이전트 이름을 지정합니다(예: `Marketing Agent`). 아래와 같이 **설명**을 입력합니다:   
   <img width="1000" alt="image" src="img/step5.png">
   - **주의사항** : 명명규칙
...
6. **지식(Knowledge)** 로 섹션으로 이동 후 Add source를 클릭합니다.
   <img width="1000" alt="image" src="img/step6.png">

7. **Add knowledge**에서 New knowledge를 클릭 후, 스크롤을 내려 Upload files를 선택하고 Next를 클릭합니다.
   <img width="1000" alt="image" src="img/step7.png">
   <img width="1000" alt="image" src="img/step8.png">
   
8. 다운받은 **LAB3 Knowledge 폴더** 내에 PDF 파일을 업로드 하고, 
Name 필드에 아래와 같이 삽입한 후 Next를 클릭합니다. :
...
9. **동작(Behavior)** 섹션으로 스크롤을 내립니다. 아래 지침을 **지침(Instructions)** 필드에 삽입합니다: 
...
10. **9번까지의 모든 과정이 완료**됐으면, Agent는 마케팅 정보와 동작 규칙을 가지게 됩니다. 
