...
이제 계좌관리 어시스턴트의 기본 흐름이 완성되었습니다.

이 실습을 통해 다음과 같은 기능을 구현했습니다.
...
추가로 다음 기능까지 확장할 수 있습니다.

* 사용자 이름 / 고객번호 입력 받기
* 계좌 개설 자격 검증
* 외부 API 또는 Extension 연동
* 계좌 개설 완료 후 후속 안내 메시지 제공
* Web chat 채널에 배포하여 실제 웹페이지에 연결
